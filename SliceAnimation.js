...
function CreateSliceBox(
  ...
  if (mainDiv == undefined) {
    ...
    document.getElementById(newMainBoxId).appendChild(newMainDiv);
  }
  ...
  newSliceBox.style.border = '1px solid black';
  ...
  SelectSliceButton_Contain.style.backgroundColor = 'white';
...
function AddSlice(BoxidNum) {
  ...
  newSlice.textContent = '' + SelectSliceMax[BoxidNum];
  newSlice.id = 'SliceBoxContent_' + SelectSliceMax[BoxidNum];
